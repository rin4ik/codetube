    ...
    <style>
            *
            ...
            .logo h1 {
                ...
                /* Old browsers */
                background: -moz-linear-gradient(top, #3e4551 0%, #3e4551 100%);
                /* FF3.6+ */
                background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #3e4551), color-stop(100%, #3e4551));
                /* Chrome,Safari4+ */
                background: -webkit-linear-gradient(top, #3e4551 0%, #3e4551 100%);
                /* Chrome10+,Safari5.1+ */
                background: -o-linear-gradient(top, #3e4551 0%, #3e4551 100%);
                /* Opera 11.10+ */
                background: -ms-linear-gradient(top, #3e4551 0%, #3e4551 100%);
                /* IE10+ */
                background: linear-gradient(to bottom, #3e4551 0%, #3e4551 100%);
                /* W3C */
                filter: progid: DXImageTransform.Microsoft.gradient( startColorstr='#3e4551', endColorstr='#3e4551', GradientType=0);
                /* IE6-9 */
        ...
        <!-- Error Page -->
            <div class="error">
                <div class="container-floud">
                    <div class="col-xs-9 ground-color text-center">
